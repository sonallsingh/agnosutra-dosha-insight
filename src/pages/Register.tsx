  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-secondary to-primary items-center justify-center p-12">
        ...
        >
          <div className="w-32 h-32 mx-auto mb-8 rounded-full bg-secondary-foreground/10 flex items-center justify-center">
          ...
          <p className="text-secondary-foreground/80 max-w-md">
            Join thousands of users who have discovered their path to 
            holistic wellness through personalized Ayurvedic insights.
          </p>
        </motion.div>
      </div>

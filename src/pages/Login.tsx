  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary to-accent items-center justify-center p-12">
        ...
        >
          <div className="w-32 h-32 mx-auto mb-8 rounded-full bg-primary-foreground/10 flex items-center justify-center">
          ...
          <p className="text-primary-foreground/80 max-w-md">
            Experience the perfect blend of ancient Ayurvedic wisdom and modern 
            AI technology tailored specifically for your unique constitution.
          </p>
        </motion.div>
      </div>
    </div>
